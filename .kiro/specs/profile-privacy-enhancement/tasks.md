...
- [ ] 1. Update User Model with Privacy Settings
...
- [ ] 2. Create Privacy Filtering Utility
...
- [ ] 3. Update Profile Controller
  - [ ] 3.1 Modify `updateProfile` endpoint to accept and save privacy settings
  ...
  - [ ] 3.2 Create `updatePrivacySettings` endpoint (PUT /api/profile/privacy)
  ...
  - [ ] 3.3 Create `getPublicProfile` endpoint (GET /api/users/:id/public-profile)
    - Fetch user by ID
    - Apply privacy filtering using utility function
    - Return filtered profile data
    - _Requirements: 2.2, 2.3, 3.2, 3.3_
  
  - [ ] 3.4 Modify `getProfile` endpoint to return privacy settings
    - Include `privacySettings` in response for own profile
    - _Requirements: 2.5, 6.5_

- [ ] 4. Add Privacy Routes
...
- [ ] 7. Create Global Visibility Toggle Component
...
- [ ] 9. Create Privacy Summary Component
...
- [ ] 10. Add Privacy Service (Frontend)
...
- [ ] 11. Update Profile Form Styling
...
- [ ]* 14. Add Privacy Settings Documentation
