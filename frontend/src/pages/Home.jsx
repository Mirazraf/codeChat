      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-20">
          <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-lg">
            ...
            <p className="text-gray-300">Real-time collaborative coding with syntax highlighting</p>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-lg">
            <MessageSquare className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">Smart Chat</h3>
            <p className="text-gray-300">Share code snippets, files, and ideas instantly</p>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-lg">
            <Users className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">Learn Together</h3>
            <p className="text-gray-300">Join classrooms, workshops, and study groups</p>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-lg">
            <Zap className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-bold text-white mb-2">Fast & Secure</h3>
            <p className="text-gray-300">Built with modern tech for speed and security</p>
          </div>
        </div>
      </div>
    </div>
